...
***PEAK*** is a cooperative climbing video game developed and published by Aggro Crab and Landfall for Windows (Steam) on 16 June 2025. The objective of the game is to climb a pre-generated mountain with up to four players.
...
There is a Stamina Bar in the bottom left of the screen, and a inventory in the bottom right of the screen, along with button prompts when holding an item.

When looking at an interactable object, there will be a interaction prompt in the middle of the screen that states the interaction name and what button to press. And lastly, there is a notification box at the top left of the screen that will indicate when players have left the game, joined the game, etc.
