...
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); gap: 16px;">
  ...
  <a href="/en/pages/developers/aggro-crab" style="text-decoration:none;">
    <div class="dev-card" data-dev-tag="aggro crab" style="border: 2.5px solid #ddd; border-radius: 8px; overflow: hidden;">
  ...
  <a href="/en/pages/developers/Jackbox-Games" style="text-decoration:none;">
    <div class="dev-card" data-dev-tag="jackbox games" style="border: 2.5px solid #ddd; border-radius: 8px; overflow: hidden;">
  ...
  <a href="/en/pages/developers/FromSoftware" style="text-decoration:none;">
    <div class="dev-card" data-dev-tag="fromsoftware" style="border: 2.5px solid #ddd; border-radius: 8px; overflow: hidden;">
  ...
  <a href="/en/pages/developers/Landfall" style="text-decoration:none;">
    <div class="dev-card" data-dev-tag="landfall games" style="border: 2.5px solid #ddd; border-radius: 8px; overflow: hidden;">
